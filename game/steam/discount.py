...
def save_discount_list(cache_file_path, discount_game_list):
    file.write_file(tool.json_encode(discount_game_list), cache_file_path, enum.WriteFileMode.REPLACE)
...
def main():
    ...
    INCLUDE_GAME = crawler.analysis_config(config, "INCLUDE_GAME", True, enum.ConfigAnalysisMode.BOOLEAN)
    INCLUDE_PACKAGE = crawler.analysis_config(config, "INCLUDE_PACKAGE", True, enum.ConfigAnalysisMode.BOOLEAN)
    INCLUDE_BUNDLE = crawler.analysis_config(config, "INCLUDE_BUNDLE", True, enum.ConfigAnalysisMode.BOOLEAN)
    SKIP_RESTRICTED_GAME = crawler.analysis_config(config, "SKIP_RESTRICTED_GAME", True, enum.ConfigAnalysisMode.BOOLEAN)
    MIN_DISCOUNT_PERCENT = crawler.analysis_config(config, "MIN_DISCOUNT_PERCENT", 75, enum.ConfigAnalysisMode.INTEGER)
    MAX_DISCOUNT_PERCENT = crawler.analysis_config(config, "MAX_DISCOUNT_PERCENT", 100, enum.ConfigAnalysisMode.INTEGER)
    MAX_SELLING_PERCENT = crawler.analysis_config(config, "MAX_SELLING_PERCENT", 1, enum.ConfigAnalysisMode.INTEGER)
