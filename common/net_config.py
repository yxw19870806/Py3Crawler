...
for config_key in ["DOWNLOAD_MULTIPART_MIN_SIZE", "DOWNLOAD_MULTIPART_BLOCK_SIZE"]:
    if config_key in config:
        config[config_key] = convert_to_bytes(config[config_key], DEFAULT_CONFIG[config_key])
