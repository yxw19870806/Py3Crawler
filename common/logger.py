...
if DEFAULT_LOG_CONFIG["IS_WRITE_DEBUG"]:
    debug_file_handle = logging.FileHandler(LOG_DEBUG_PATH)
...
if DEFAULT_LOG_CONFIG["IS_WRITE_INFO"]:
    info_file_handle = logging.FileHandler(LOG_INFO_PATH)
...
if DEFAULT_LOG_CONFIG["IS_WRITE_WARNING"]:
    warning_file_handle = logging.FileHandler(LOG_WARNING_PATH)
...
if DEFAULT_LOG_CONFIG["IS_WRITE_ERROR"]:
    error_file_handle = logging.FileHandler(LOG_ERROR_PATH)
