...
def get_index_page():
    ...
    new_album_html = tool.find_sub_string(index_response_content, '<div class="zuixin">最新发布</div>', '<div class="zuixin">名站写真</div>')
...
class Download(crawler.DownloadThread):
    ...
    def run(self):
        self.result = net.save_net_file(self.photo_url, self.file_path, header_list={"Referer": "https://www.meitulu.com/"})
