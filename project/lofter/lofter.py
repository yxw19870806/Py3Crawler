...
def get_blog_id(blog_url):
    return int(url.get_basename(blog_url).split("_")[-1], 16)
...
class CrawlerThread(crawler.CrawlerThread):
    ...
    def crawl_blog(self, blog_url):
        ...
        try:
            ...
            raise
        blog_description = f"日志{blog_url}({blog_url})"
        ...
        for photo_url in blog_response["photo_url_list"]:
            ...
            photo_description = f"{blog_description} 第{photo_index}/{blog_response['photo_url_list']}张图片"
