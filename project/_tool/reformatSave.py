...
def reformat_save():
    new_lines = []
    for line in file.read_file(OLD_SAVE_FILE_PATH, enum.ReadFileMode.LINE):
    ...
    file.write_file("\n".join(new_lines), NEW_SAVE_FILE_PATH, enum.WriteFileMode.REPLACE)
