...
def main():
    # 初始化类
    hinatazaka46diary_class = hinatazaka46_diary.Hinatazaka46Diary(extra_sys_config={crawler.SysConfigKey.NOT_CHECK_SAVE_DATA: True})
    ...
    if len(account_list_from_api) > 0:
        ...
        file.write_file(tool.list_to_string(temp_list), hinatazaka46diary_class.save_data_path, file.WRITE_FILE_TYPE_REPLACE)
